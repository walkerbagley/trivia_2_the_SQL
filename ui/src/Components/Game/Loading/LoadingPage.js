...
const LoadingPage = () => {
    ...
    const facts = [
        ...
        'The worlds smallest winged insect, the Tanzanian parasitic wasp, is smaller than the eye of a housefly.',
        ...
        'A dogs sense of smell is 1,000 times more sensitive than a humans.',
        ...
        'To escape the Earths gravity a rocket need to travel at 7 miles a second.',
        ...
        'A spiders web is not a home, but rather a trap for its food. They are as individual as snowflakes, with no two ever being the same. Some tropical spiders have built webs over eighteen feet across.',
        ...
        'Your brain consumes 25 watts of power while youre awake. This amount of energy is enough to illuminate a lightbulb.',
        ...
        'The most poisonous spider is the black widow. Its venom is more potent than a rattlesnakes.',
        ...
        'Fish that live more than 800 meters below the ocean surface dont have eyes.',
        ...
        'The "Dull Mens Hall of Fame" is located in Carroll, Wisconsin.',
        ...
        'Greeces national anthem has 158 verses.',
        ...
        'Russians generally answer the phone by saying, "Im listening".',
        ...
        'Frank Lloyd Wrights son invented Lincoln Logs.',
        'Peter Falk, who played "Columbo," has a glass eye.',
        'Barbies full name is "Babara Millicent Roberts."',
        ...
        'Adolf Hitlers mother seriously considered having an abortion but was talked out of it by her doctor.',
        ...
        'The penguin is the only bird that can swim but cant fly.',
